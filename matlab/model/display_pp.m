function display_pp(res,average_rep)
        ...
        for l=1:idl
            for r=1:idr
                if average_rep
                    ...
                    pp=num2cell(pp);
                    fprintf('\t %d \t %d \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f\n',...
                                l,   r,   pp{:});
                else
                    for rep=1:reps
                        ps=res{s,l,r,rep,1};
                        ...
                        fprintf('\t %d \t %d \t %d \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f \t %2.2f\n',...
                                   l,   r,    rep,  ps(1),ps(2),6*ps(12),6*ps(13),4*sg(1),4*sg(2),4*sg(3),4*sg(4),ghdist1,ghdist2);
                    end
                    if r<idr
                        fprintf('.  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .\n')
                    end
    ...
    for s=1:ss
        ...
        for i=1:id            
            if average_rep
                ...
                pp=num2cell(pp);
                fprintf('\t %d  \t %2.2f \t %2.2f \t %2.2f \t %2.2f\n',i,pp{:});
            else
                for rep=1:reps
                    ps=res{s,i,rep,1};
                    sg=res{s,i,rep,2};
                    fprintf('\t %d  \t %d \t %2.2f \t %2.2f \t %2.2f \t %2.2f\n',...
                                i,   rep,  ps(1),6*ps(end),4*sg(1),4*sg(2));
                end
            end
            fprintf('----------------------------------------------------------------------------------------------\n')
        end        
