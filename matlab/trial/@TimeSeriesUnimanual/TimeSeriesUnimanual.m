classdef TimeSeriesUnimanual < handle
    ...
    methods%Properties getters and setter
        ...
        function xraw_phhist = get.xraw_phhist(ts)
            xraw_phhist=get_ph_histogram(ts.xraw,ts.ph,ts.conf.hist_bins);
        end
        
        
        function vraw_phhist = get.vraw_phhist(ts)
            vraw_phhist=get_ph_histogram(ts.vraw,ts.ph,ts.conf.hist_bins);
        end
        
        
        function araw_phhist = get.araw_phhist(ts)
            araw_phhist=get_ph_histogram(ts.araw,ts.ph,ts.conf.hist_bins);
        end
        
        function x_phhist = get.x_phhist(ts)
            x_phhist=get_ph_histogram(ts.x,ts.ph,ts.conf.hist_bins);
        end
        
        
        function v_phhist = get.v_phhist(ts)
            v_phhist=get_ts_phhistogram(ts.v,ts.ph,ts.conf.hist_bins);
        end
        
        
        function a_phhist = get.a_phhist(ts)
            a_phhist=get_ph_histogram(ts.a,ts.ph,ts.conf.hist_bins);
        end
        
        
        function jerk_phhist = get.jerk_phhist(ts)
            jerk_phhist=get_ph_histogram(ts.jerk,ts.ph,ts.conf.hist_bins);            
        end
        ...
        function omega_phhist = get.omega_phhist(ts)
            omega_phhist=get_ph_histogram(ts.omega,ts.ph,ts.conf.hist_bins);
        end
        ...
        function alpha_phhist = get.alpha_phhist(ts)
            alpha_phhist=get_ph_histogram(ts.alpha,ts.ph,ts.conf.hist_bins);
        end
        
        
        function amp_phhist = get.amp_phhist(ts)
            amp_phhist=get_ph_histogram(ts.amp,ts.ph,ts.conf.hist_bins);
        end
